...
public class OtherViewer extends Canvas implements Runnable {
    ...
    public OtherViewer() {
        ...
        try {
            this.imagen = ImageIO.read((new File("C:\\Users\\marco\\Desktop\\Workspace\\DAM\\DAM2\\Jumi\\JumiYincanas\\layouts\\animacion\\fondo.jpg")));
        } catch (IOException e) {
    ...
    public void paintRectangle() {
        Graphics g = this.getGraphics();
        g.drawRect(cordenadaX, cordenadaY, 100, 100);
    }

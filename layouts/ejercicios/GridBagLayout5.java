...
// ! Ejes X e Y aplicados, se creará un JPanel donde se introducirán todos los elementos. De esta forma se consigue que los ejes no cambien sus distancias
public class GridBagLayout5 extends JFrame implements ActionListener {
    ...
    public void addElementsWithConstraints() {
        ...
        this.jPanel.add(this.jScrollPaneDeJTextArea, gridBagConstraints);
        ...
        this.jPanel.add(this.jTextFieldInputs, gridBagConstraints);
        ...
        this.jPanel.add(this.jButtonUpdateJTextArea, gridBagConstraints);
        ...
        this.jPanel.add(jPanelBotonesLateral, gridBagConstraints);
    ...
    public static void main(String[] args) {
        GridBagLayout5 gridBagLayout5 = new GridBagLayout5();
        System.out.println(gridBagLayout5.toString());
